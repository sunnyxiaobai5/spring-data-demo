...
INSERT INTO `MENU` (`NAME`, `IS_SYSTEM`, `STATE`, `ICON_URL`, `PARENT_ID`, `IS_SHORTCUT_MENU`) VALUES ('系统1-模块1', FALSE, 'module1', NULL, 1, FALSE);
INSERT INTO `MENU` (`NAME`, `IS_SYSTEM`, `STATE`, `ICON_URL`, `PARENT_ID`, `IS_SHORTCUT_MENU`) VALUES ('系统1-模块2', FALSE, 'module2', NULL, 1, FALSE);
